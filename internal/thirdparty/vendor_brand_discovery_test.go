...
func TestVendorBrandDiscoveryRejectsUnsafeDNSAnswers(t *testing.T) {
	...
	unsafe := []string{
		...
		"192.0.2.1", "192.168.1.1", "192.175.48.1", "198.18.0.1", "198.51.100.1", "203.0.113.1", "224.0.0.1", "240.0.0.1",
		"::", "::1", "64:ff9b::7f00:1", "fc00::1", "fec0::1", "fe80::1", "ff02::1", "2001:db8::1", "2002:7f00:1::", "2620:4f:8000::1", "3fff::1",
	}
