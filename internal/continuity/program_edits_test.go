...
func TestSupersedeRequirementPreservesHistory(t *testing.T) {
	...
	created, err := service.CreateProgram(t.Context(), CreateProgramInput{
		TenantID: "bank", Code: "NDPA", Name: "Data protection", Type: "PRIVACY",
	...
	withRequirement, err := service.AddRequirement(t.Context(), AddRequirementInput{
		TenantID: "bank", ProgramID: created.Program.ID, ExpectedVersion: created.Program.Version,
...
func TestSupersedeRequirementRejectsInvalidHistoryChanges(t *testing.T) {
	...
	_, err = service.SupersedeRequirement(t.Context(), SupersedeRequirementInput{
