...
var (
	...
	ErrOutboundFrozen              = &Error{Code: "outbound_ai_frozen", Message: "Outbound AI use is temporarily suspended by the organization.", Status: http.StatusServiceUnavailable, Retriable: true}
	ErrEmergencyControlUnavailable = &Error{Code: "emergency_control_unavailable", Message: "The gateway cannot verify the organization emergency-control state.", Status: http.StatusServiceUnavailable, Retriable: true}
