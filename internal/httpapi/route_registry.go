...
func (a *API) routes() []routeSpec {
	routes := []routeSpec{
		...
		material("/api/v1/programs/{id}/form-templates/{form_id}/transition", "program.monitoring.form.transition", a.transitionFormTemplate, commandPolicy{ObjectType: "PROGRAM", Responsibility: authority.ResponsibilityReviewer, Materiality: 3, ActorField: noActorField}),
