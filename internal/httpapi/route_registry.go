...
func (a *API) routes() []routeSpec {
	routes := []routeSpec{
		...
		material("/api/v1/vendors/{id}/work/{request_id}/send", "thirdparty.work.send", a.sendVendorWork, commandPolicy{ObjectType: "VENDOR_RELATIONSHIP", Responsibility: authority.ResponsibilityOwner, Materiality: 3}),
		material("/api/v1/vendors/{id}/work/{request_id}/review/start", "thirdparty.work.review", a.startVendorWorkReview, commandPolicy{ObjectType: "VENDOR_RELATIONSHIP", Responsibility: authority.ResponsibilityReviewer, Materiality: 3}),
		material("/api/v1/vendors/{id}/work/{request_id}/changes", "thirdparty.work.request_changes", a.requestVendorWorkChanges, commandPolicy{ObjectType: "VENDOR_RELATIONSHIP", Responsibility: authority.ResponsibilityReviewer, Materiality: 3}),
		material("/api/v1/vendors/{id}/work/{request_id}/accept", "thirdparty.work.accept", a.acceptVendorWork, commandPolicy{ObjectType: "VENDOR_RELATIONSHIP", Responsibility: authority.ResponsibilityReviewer, Materiality: 3}),
		material("/api/v1/vendors/{id}/work/{request_id}/cancel", "thirdparty.work.cancel", a.cancelVendorWork, commandPolicy{ObjectType: "VENDOR_RELATIONSHIP", Responsibility: authority.ResponsibilityOwner, Materiality: 3}),
		material("/api/v1/vendors/{id}/work/{request_id}/retry", "thirdparty.work.retry", a.retryVendorWork, commandPolicy{ObjectType: "VENDOR_RELATIONSHIP", Responsibility: authority.ResponsibilityOwner, Materiality: 3}),
