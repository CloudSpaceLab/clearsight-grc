...
func (a *API) routes() []routeSpec {
	routes := []routeSpec{
		...
		withPermission(read("/api/v1/vendors", a.listVendorRelationships), identity.PermissionVendorRead),
		...
		withPermission(read("/api/v1/vendors/{id}", a.getVendorRelationship), identity.PermissionVendorRead),
		...
		withPermission(read("/api/v1/vendors/{id}/links", a.listVendorRelationshipLinks), identity.PermissionVendorRead),
		withPermission(read("/api/v1/vendor-links", a.listVendorRelationshipLinks), identity.PermissionVendorRead),
		...
		withPermission(read("/api/v1/vendor-work", a.listVendorWork), identity.PermissionVendorRead),
		withPermission(read("/api/v1/vendor-work/{request_id}", a.getVendorWork), identity.PermissionVendorRead),
		withPermission(read("/api/v1/vendors/{id}/work/{request_id}/response", a.getVendorWorkResponse), identity.PermissionVendorRead),
		withPermission(read("/api/v1/vendors/{id}/work/{request_id}/requests/{capture_request_id}/documents/{artifact_id}/open", a.openVendorWorkDocument), identity.PermissionVendorRead),
		...
		withPermission(read("/api/v1/vendors/{id}/assessments/current", a.getCurrentVendorAssessment), identity.PermissionVendorRead),
		...
		withPermission(read("/api/v1/vendor-assessments/{id}", a.getVendorAssessmentReview), identity.PermissionVendorRead),
		withPermission(read("/api/v1/vendor-assessments/{id}/requests/{request_id}/documents/{artifact_id}/open", a.openVendorAssessmentDocument), identity.PermissionVendorRead),
