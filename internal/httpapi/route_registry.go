...
func (a *API) routes() []routeSpec {
	routes := []routeSpec{
		...
		material("/api/v1/vendors/{id}/work/{request_id}/changes", "thirdparty.work.request_changes", a.requestVendorWorkChanges, commandPolicy{ObjectType: "VENDOR_RELATIONSHIP", Responsibility: authority.ResponsibilityReviewer, DecisionType: "thirdparty.work.review", Materiality: 3, OutcomeObjectType: "VENDOR_WORK_REQUEST", OutcomePathValue: "request_id"}),
