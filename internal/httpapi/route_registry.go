...
func (a *API) routes() []routeSpec {
	routes := []routeSpec{
		...
		withPermission(material("/api/v1/third-party-activation-policies", thirdparty.ActivationPolicyProposeCommand, a.proposeThirdPartyActivationPolicy, commandPolicy{ObjectType: "LEGAL_ENTITY", Responsibility: authority.ResponsibilityOwner, Materiality: 4, BindLegalEntity: true, ActorField: noActorField}), identity.PermissionConfigWrite),
		...
		withPermission(material("/api/v1/third-party-activation-policies/{id}/simulate", thirdparty.ActivationPolicySimulateCommand, a.simulateThirdPartyActivationPolicy, commandPolicy{ObjectType: "THIRD_PARTY_ACTIVATION_POLICY", ObjectIDPath: "id", Responsibility: authority.ResponsibilityOwner, Materiality: 4, ActorField: noActorField}), identity.PermissionConfigWrite),
		withPermission(material("/api/v1/third-party-activation-policies/{id}/submit", thirdparty.ActivationPolicySubmitCommand, a.submitThirdPartyActivationPolicy, commandPolicy{ObjectType: "THIRD_PARTY_ACTIVATION_POLICY", ObjectIDPath: "id", Responsibility: authority.ResponsibilityOwner, Materiality: 4, ActorField: noActorField}), identity.PermissionConfigWrite),
		material("/api/v1/third-party-activation-policies/{id}/approve", thirdparty.ActivationPolicyApproveCommand, a.approveThirdPartyActivationPolicy, commandPolicy{ObjectType: "THIRD_PARTY_ACTIVATION_POLICY", ObjectIDPath: "id", Responsibility: authority.ResponsibilityAuthorizer, Materiality: 4, ActorField: noActorField}),
		withPermission(material("/api/v1/third-party-activation-policies/{id}/rollback", thirdparty.ActivationPolicyRollbackCommand, a.rollbackThirdPartyActivationPolicy, commandPolicy{ObjectType: "THIRD_PARTY_ACTIVATION_POLICY", ObjectIDPath: "id", Responsibility: authority.ResponsibilityOwner, Materiality: 4, ActorField: noActorField}), identity.PermissionConfigWrite),
		...
		material("/api/v1/matters/{id}/form-remediations/{binding_id}/send", "matter.form-remediation.send", a.sendMatterFormRemediation, commandPolicy{ObjectType: "MATTER", Responsibility: authority.ResponsibilityOwner, Materiality: 3, ActorField: noActorField}),
		material("/api/v1/matters/{id}/form-remediations/{binding_id}/apply", "matter.form-remediation.apply", a.applyMatterFormRemediation, commandPolicy{ObjectType: "MATTER", Responsibility: authority.ResponsibilityReviewer, Materiality: 4, ActorField: noActorField}),
		...
		material("/api/v1/matters/{id}/actions/{action_id}/update-requests", "matter.action.update.request", a.requestMatterActionUpdate, commandPolicy{ObjectType: "MATTER", Responsibility: authority.ResponsibilityOwner, Materiality: 2}),
		...
		withPermission(material("/api/v1/operations/background-jobs/{job_id}/retry", "background_job.retry", a.retryBackgroundJob, commandPolicy{ObjectType: "BACKGROUND_JOB", Responsibility: authority.ResponsibilityAuthorizer, Materiality: 4, ActorField: noActorField}), identity.PermissionPlatformOperationsWrite),
		...
		read("/api/v1/evidence/requests/{id}/review-submission", a.getEvidenceReviewSubmission),
		...
		read("/api/v1/document-imports/{id}/risk-register", a.getRiskRegisterMigration),
		material("/api/v1/document-imports/{id}/risk-register/save", "document.register.save", a.saveRiskRegisterMigration, commandPolicy{ObjectType: "DOCUMENT_IMPORT", ObjectIDPath: "id", Responsibility: authority.ResponsibilityOwner, Materiality: 3, ActorField: noActorField}),
		material("/api/v1/document-imports/{id}/risk-register/import", "document.register.import", a.commitRiskRegisterMigration, commandPolicy{ObjectType: "DOCUMENT_IMPORT", ObjectIDPath: "id", Responsibility: authority.ResponsibilityOwner, Materiality: 3, ActorField: noActorField}),
