...
func (a *API) routes() []routeSpec {
	routes := []routeSpec{
		...
		withPermission(write(http.MethodPost, "/api/v1/governance/policies", a.createGovernancePolicy, bindJSONIdentity(true, "maker_id")), identity.PermissionConfigWrite),
		withPermission(write(http.MethodPost, "/api/v1/governance/policies/{id}/submit", a.governancePolicyAction("submit"), bindJSONIdentity(true, "actor_id")), identity.PermissionConfigWrite),
		withPermission(write(http.MethodPost, "/api/v1/governance/policies/{id}/approve", a.governancePolicyAction("approve"), bindJSONIdentity(true, "actor_id")), identity.PermissionConfigWrite),
		withPermission(write(http.MethodPost, "/api/v1/governance/policies/{id}/reject", a.governancePolicyAction("reject"), bindJSONIdentity(true, "actor_id")), identity.PermissionConfigWrite),
		withPermission(write(http.MethodPost, "/api/v1/governance/policies/{id}/retire", a.governancePolicyAction("retire"), bindJSONIdentity(true, "actor_id")), identity.PermissionConfigWrite),
		withPermission(read("/api/v1/governance/delegations", a.listGovernanceDelegations), identity.PermissionConfigRead),
		withPermission(write(http.MethodPost, "/api/v1/governance/delegations", a.createGovernanceDelegation, bindJSONIdentity(true, "maker_id")), identity.PermissionConfigWrite),
		withPermission(write(http.MethodPost, "/api/v1/governance/delegations/{id}/submit", a.governanceDelegationAction("submit"), bindJSONIdentity(true, "actor_id")), identity.PermissionConfigWrite),
		withPermission(write(http.MethodPost, "/api/v1/governance/delegations/{id}/approve", a.governanceDelegationAction("approve"), bindJSONIdentity(true, "actor_id")), identity.PermissionConfigWrite),
		withPermission(write(http.MethodPost, "/api/v1/governance/delegations/{id}/revoke", a.governanceDelegationAction("revoke"), bindJSONIdentity(true, "actor_id")), identity.PermissionConfigWrite),
