...
func (a *API) aiGatewayTransportRoutes() []routeSpec {
	...
	emergency := "/api/v1/ai-governance/gateway-emergency-control"
	return []routeSpec{
		...
		withPermission(write(http.MethodPost, emergency, a.setAIGatewayEmergencyControl, nil), identity.PermissionConfigWrite),
