...
func TestAdministrativePermissionsLiveInRouteRegistry(t *testing.T) {
	...
	expected := map[string]string{
		...
		"GET /api/v1/access/overview":                            identity.PermissionIdentityRead,
		"POST /api/v1/access/scim-sources":                       identity.PermissionIdentityConfigure,
		"POST /api/v1/access/scim-sources/{id}/rotate-token":     identity.PermissionIdentityConfigure,
		"POST /api/v1/access/scim-sources/{id}/revoke":           identity.PermissionIdentityConfigure,
		"POST /api/v1/access/group-role-bindings":                identity.PermissionIdentityConfigure,
		"POST /api/v1/access/group-role-bindings/{id}/retire":    identity.PermissionIdentityConfigure,
		"POST /api/v1/access/escalations/preview":                 identity.PermissionIdentityRead,
	}
