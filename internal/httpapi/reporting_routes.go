...
func (a *API) reportingRoutes() []routeSpec {
	return []routeSpec{
		...
		read("/api/v1/reports/definitions/{id}", a.getReportDefinition),
		read("/api/v1/reports/definitions/{id}/history", a.getReportDefinitionHistory),
		material("/api/v1/reports/definitions/{id}/submit", "report.definition.submit", a.reportDefinitionAction("submit"), commandPolicy{
			ObjectType: "REPORT_DEFINITION", ObjectIDPath: "id", Responsibility: authority.ResponsibilityProposer, Materiality: 4,
		}),
		material("/api/v1/reports/definitions/{id}/review", "report.definition.review", a.reportDefinitionAction("review"), commandPolicy{
			ObjectType: "REPORT_DEFINITION", ObjectIDPath: "id", Responsibility: authority.ResponsibilityReviewer, Materiality: 4,
		}),
		material("/api/v1/reports/definitions/{id}/activate", "report.definition.activate", a.reportDefinitionAction("activate"), commandPolicy{
			ObjectType: "REPORT_DEFINITION", ObjectIDPath: "id", Responsibility: authority.ResponsibilityAuthorizer, Materiality: 5,
		}),
		material("/api/v1/reports/definitions/{id}/reject", "report.definition.reject", a.reportDefinitionAction("reject"), commandPolicy{
			ObjectType: "REPORT_DEFINITION", ObjectIDPath: "id", Responsibility: authority.ResponsibilityReviewer, Materiality: 4,
		}),
		material("/api/v1/reports/definitions/{id}/retire", "report.definition.retire", a.reportDefinitionAction("retire"), commandPolicy{
			ObjectType: "REPORT_DEFINITION", ObjectIDPath: "id", Responsibility: authority.ResponsibilityAuthorizer, Materiality: 5,
		}),
		read("/api/v1/reports/runs", a.listReportRuns),
		material("/api/v1/reports/runs", "report.run.create", a.createReportRun, commandPolicy{
