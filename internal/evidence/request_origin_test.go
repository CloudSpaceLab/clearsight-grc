...
func TestCreateRequestReusesExactOrigin(t *testing.T) {
	...
	input.Origin = RequestOrigin{Type: OriginMonitoringCollection, ID: "11111111-1111-7111-8111-111111111111", Version: 1}
...
func TestCreateRequestKeepsOriginsTenantScoped(t *testing.T) {
	...
	inputA.Origin = RequestOrigin{Type: OriginMonitoringCollection, ID: "11111111-1111-7111-8111-111111111111", Version: 1}
...
func TestCreateRequestValidatesPredecessorOriginAndSubject(t *testing.T) {
	...
	secondInput.Origin = RequestOrigin{Type: OriginMonitoringCollection, ID: firstInput.Origin.ID, Version: 2}
	...
	wrongSubject.Origin = RequestOrigin{Type: OriginMonitoringCollection, ID: firstInput.Origin.ID, Version: 3}
	...
	missingPredecessor.Origin = RequestOrigin{Type: OriginMonitoringCollection, ID: "22222222-2222-7222-8222-222222222222", Version: 2}
