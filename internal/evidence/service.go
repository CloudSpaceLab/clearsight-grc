...
func validateRequestInput(input CreateRequestInput) error {
	...
	if err := validateRequestOrigin(input.Origin, input.PredecessorRequestID); err != nil {
		return err
	}
