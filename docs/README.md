...
36. [Document navigation and fictional samples](superpowers/specs/2026-09-08-document-navigation-and-samples-design.md), [navigation plan](superpowers/plans/2026-09-08-document-navigation.md), [vendor recovery plan](superpowers/plans/2026-09-08-vendor-activation-recovery.md) and [sample implementation plan](superpowers/plans/2026-09-08-demo-document-samples.md) — narrow-screen selectors, safe activation retries and a clearly labelled demo-only preview exception for exact reviewed fictional bytes; no antivirus or review-acceptance claim.
