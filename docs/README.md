...
38. [`superpowers/specs/2026-09-23-ropa-register-and-reporting-design.md`](superpowers/specs/2026-09-23-ropa-register-and-reporting-design.md), [`superpowers/plans/2026-09-23-ropa-register-and-dashboard.md`](superpowers/plans/2026-09-23-ropa-register-and-dashboard.md) and [`superpowers/plans/2026-09-24-ropa-configurable-report-builder.md`](superpowers/plans/2026-09-24-ropa-configurable-report-builder.md) — ROPA register, dashboard, configurable report builder and deferred review-automation scope.
...
- ROPA processing-activity register with tenant/legal-entity-scoped current rows, immutable revisions and append-only events, the four closure conditions, structured cross-border transfer tracking, projection-backed coverage/freshness, bounded register reads, and register/activity screens; governed configurable exception/compliance reports with bounded run-now generation and protected downloads; automated review reminders and collaboration notifications remain deferred;
...
The ROPA register and configurable report-builder tranches are implemented in code with their migrations, routes, projection, bounded reads, report workspace, bounded runs and protected downloads. The separate system-activity CSV/NDJSON export remains distinct from #26's configurable exception/compliance report builder. #26 remains Partial because scheduled or recurring reports, cross-legal-entity reporting and row-level streaming are not delivered; #28/#29 review-cycle automation, reminders, collaboration and notifications remain deferred. Automated rendered review records exist, but representative behavioural bank acceptance for the ROPA surfaces has not been recorded.
