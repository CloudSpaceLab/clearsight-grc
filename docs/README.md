...
4. [`architecture/program-and-matter-foundation.md`](architecture/program-and-matter-foundation.md) — executable Program state, typed Matters, closure and reconstruction.
...
10. [`product/plain-language-content-standard.md`](product/plain-language-content-standard.md) — human working language over stable internal codes.
11. [`product/enterprise-copy-and-content-design.md`](product/enterprise-copy-and-content-design.md) — realistic operational wording, count integrity and content acceptance.
...
20. [`quality/release-gates-and-traceability.md`](quality/release-gates-and-traceability.md), [`quality/program-matter-acceptance-tests.md`](quality/program-matter-acceptance-tests.md) and domain acceptance tests.
