...
5. [`product/experience-principles.md`](product/experience-principles.md) — Today, Programs, Work, Explore, Configure, Respond/Capture, interaction principles, and timed golden flows.
6. [`product/ux-and-visual-language.md`](product/ux-and-visual-language.md) — behavioral psychology, colors, typography, visual hierarchy, components, input collection, motion, responsiveness, accessibility, and reports.
7. [`product/regulatory-and-enforcement-intelligence.md`](product/regulatory-and-enforcement-intelligence.md) — regulatory change, supervisory work, protected authority cases, rule composition, and response packages.
8. [`product/differentiation.md`](product/differentiation.md) — product moat and category boundaries.
9. [`../AGENTS.md`](../AGENTS.md) — mandatory contributor and non-regression rules.
10. [`architecture/continuous-compliance-architecture.md`](architecture/continuous-compliance-architecture.md) — cross-cutting Program, Matter, context assembly, prefill, recommendation, trigger, workflow-efficiency, and authorization architecture.
11. [`implementation-plan.md`](implementation-plan.md) — phased delivery plan with usability gates.
12. [`quality/acceptance-tests.md`](quality/acceptance-tests.md) — timed end-to-end, usability, security, evidence, AI, visual, accessibility, and resilience requirements.
13. [`quality/regulatory-and-enforcement-acceptance-tests.md`](quality/regulatory-and-enforcement-acceptance-tests.md) — specialized authority-source, legal-basis, case, response, and leakage tests.
...
- [`product/experience-principles.md`](product/experience-principles.md) — information architecture, interaction grammar, role experiences, component behavior, accessibility, and timed flows.
- [`product/ux-and-visual-language.md`](product/ux-and-visual-language.md) — implementation-ready visual language: behavioral goals, semantic tokens, typography scale, spacing, component selection, input UX, animation, responsive behavior, and governed report design.
...
Component architecture documents explain internal mechanisms. They must not override Program/Matters semantics, usability standards, visual-language rules, or primary navigation.
...
- [`quality/acceptance-tests.md`](quality/acceptance-tests.md) — timed first-use and repeat-use tests, active-effort budgets, prefill, integration reuse, AI usefulness, accessibility parity, visual-language conformance, and complete golden journeys.
...
- design-token implementation and theme strategy;
- responsive component behavior and report rendering;
...
6. [`product/experience-principles.md`](product/experience-principles.md) for experience architecture and interaction behavior;
7. [`product/ux-and-visual-language.md`](product/ux-and-visual-language.md) for visual tokens, component selection, input patterns, motion, responsiveness, and reports;
8. [`../AGENTS.md`](../AGENTS.md) for contributor rules;
9. architecture documents for internal mechanisms;
...
- experience, visual-language, and ease-of-use rules where workflow or presentation changes;
- architecture mapping or ADR;
- implementation-plan task or gate;
- acceptance tests;
- review document when resolving a listed issue.

Do not silently change product semantics, workflow-effort expectations, visual tokens, source behavior, prompts, UI, or integrations in code.