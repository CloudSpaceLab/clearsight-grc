...
| DOC-16 | P1 | Forms/Evidence: existing response-summary visibility | Before release, deny titles/IDs/timestamps/scores for vendor work whose restricted target the actor cannot read; filter before pagination and retain authorized generic Forms access. The new raw-answer detail exposure was fixed separately in `14ab785f`. |
