...
| 2026-09-03 | Replayed the feature onto the updated `main` line, consolidated its schema into migration `000077_program_collection_renewal` after the latest remote migration, and reused the existing text-based capture origin/version contract in `15220bd8`. |
