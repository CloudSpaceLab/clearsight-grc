...
WHERE id = '00000000-0000-4000-8000-000000000509'
...
BEGIN
  ...
  IF (
    ...
    WHERE rt.tenant_id = '00000000-0000-4000-8000-000000000001'
      ...
      AND op.occupant_principal_id = '00000000-0000-4000-8000-000000000108'::uuid
  ) <> 1 OR EXISTS (
    SELECT 1
    FROM role_templates rt
    JOIN position_role_bindings prb ON prb.role_template_id = rt.id AND prb.tenant_id = rt.tenant_id
    ...
    RAISE EXCEPTION 'demo performer route does not resolve only the Evidence Respondent';
  END IF;
END
$authority_v2$;
COMMIT;
