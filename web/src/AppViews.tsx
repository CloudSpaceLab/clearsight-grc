...
export function WorkView({ organizationName, tab, onTab, onBackMatter, sources, requests, evidenceSourceState, evidenceRequestState, onEvidenceRetry, matterTargetID, openFirstMatter, evidenceTargetID, openFirstEvidence, onOpenEvidence }: { organizationName: string; tab: "matters" | "evidence"; onTab: (value: "matters" | "evidence") => void; onBackMatter: () => void; sources: EvidenceSource[]; requests: EvidenceRequest[]; evidenceSourceState: SectionLoadState; evidenceRequestState: SectionLoadState; onEvidenceRetry: () => void; matterTargetID?: string; openFirstMatter?: boolean; evidenceTargetID?: string; openFirstEvidence?: boolean; onOpenEvidence: (id: string) => void }) {
  return <>
    ...
    {tab === "matters" ? <WorkspaceErrorBoundary label="Issues and changes"><MattersWorkspace targetID={matterTargetID} openFirst={openFirstMatter} onBack={onBackMatter}/></WorkspaceErrorBoundary> : <EvidenceWorkspace sources={sources} requests={requests} sourceState={evidenceSourceState} requestState={evidenceRequestState} targetID={evidenceTargetID} openFirst={openFirstEvidence} onOpenRequest={onOpenEvidence}/>} 
