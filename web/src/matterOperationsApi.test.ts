  ...
  it.each([
    ...
    },
    {
      ...
      run: () => defineMatterOutcomeCheck("matter-1", 12, {
        ...
        observationPeriodMinutes: 1440, failureResponse: "Reopen the action and notify Compliance.",
      }),
      ...
      body: {
        ...
        expected_outcome: "All annual return sections have current evidence.", baseline: {}, scope: {}, threshold: {},
        observation_period_minutes: 1440, failure_response: "Reopen the action and notify Compliance.",
      },
    },
