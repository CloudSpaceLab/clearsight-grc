...
const application = uiGalleryEvidence
  ...
  : lifecycleEvidence
    ...
    : operatingEvidence
      ...
      : <DemoAuthGate presentation={presentation}><Suspense fallback={<p role="status">Loading the ClearSight workspace…</p>}><App presentation={presentation}/></Suspense></DemoAuthGate>;
