  ...
  return <section className="forms-task-shell" aria-labelledby="sent-forms-title">
    ...
    <div className="forms-task-layout">
      <div className="forms-table-wrap">
        ...
        {items.length === 0 && <div className="forms-task-empty"><strong>No distributions match this view</strong><span>Change the server-backed filters or send a governed form.</span></div>}
