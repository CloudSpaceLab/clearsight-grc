...
beforeEach(() => {
  api.loadOversight.mockResolvedValue({
    ...
    freshness: "CURRENT",
    source_high_water: { matters: "2026-09-01T07:54:00Z" },
    ...
    performance: [{ owner_id: "person-1", owner_name: "Ada Okafor", current_load: 5, completed: 8, median_hours: 30, p75_hours: 52, sla_attainment: .875, blocked: 1, reopened: 1, measurement_samples: 8 }],
