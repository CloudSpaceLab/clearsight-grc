...
function App({ presentation = "demo" }: { presentation?: RuntimePresentation }) {
  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      {activeView === "programs" && <ProgramsView organizationName={organizationName} actorPrincipalID={runtime?.actor.id} targetID={target.programID} openFirst={target.openFirstProgram}/>}
