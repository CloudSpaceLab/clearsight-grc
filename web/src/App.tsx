...
function App({ presentation = "enterprise" }: { presentation?: RuntimePresentation }) {
  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      {activeView === "imports" && importsEnabled && <><header className="topbar"><div><span className="eyebrow">{organizationName}</span><h1>Imports</h1><p>Analyze documents against current Programs, controls and evidence, then review source-backed suggestions to create draft Programs, requirements or issues.</p></div></header><DocumentImportWorkspace/></>}
