...
function App({ presentation = "demo" }: { presentation?: RuntimePresentation }) {
  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      {activeView === "vendors" && <VendorsWorkspace organizationName={organizationName} legalEntityName={legalEntityName} targetID={target.vendorRelationshipID} onTarget={(id) => navigate("vendors", id ? { vendorRelationshipID: id } : {})} onOpenRequest={(id) => navigate("work", { evidenceID: id }, "evidence")}/>}
